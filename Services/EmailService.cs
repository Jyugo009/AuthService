...
<div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;'>
    ...
    <p>Здравствуйте!</p>
    <p>Вы запросили сброс пароля для аккаунта в <strong>AuthService</strong>.</p>
    ...
    <p>С уважением,<br>Команда AuthService</p>
</div>";

            var msg = MailHelper.CreateSingleEmail(
                from, to, subject, plainTextContent, htmlContent
                );
            Console.WriteLine($"Отправка письма для {email}. Ключ: {_config["SendGrid:ApiKey"]}");
            Console.WriteLine($"Ссылка: {resetLink}");
